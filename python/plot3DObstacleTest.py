...
rootDirectoryPath = "/home/ryan/Desktop/tmp-test/ObstacleTest_3D_VarianceModulated/"
# rootDirectoryPath = "/home/ryan/Desktop/tmp-test/ObstacleTest_3D/"
...
for iterationIndex in range(len(trajOnlyDir)):
    ...
    TP.plotTrajectory_ObstacleTest3D(savePlot, showPlot, saveDir)

    CP = costPlotter(trajDir + trajLatestDir)

    CP.plotCosts(savePlot, showPlot, saveDir)

    plotBayesianOptimization(solverDir, savePlot, showPlot, saveDir)
