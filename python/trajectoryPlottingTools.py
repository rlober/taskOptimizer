...
class trajectoryPlotter():
    ...
    def plotTrajectory_ObstacleTest1D(self, savePlot=True, showPlot=True, saveDir="./", extension=".png"):
        fs = 10 # fontsize for axes
        dof_labels = ['x','y','z']
        var_color = 'r'
        var_alpha = 0.3
    ...
    def plotTrajectory_ObstacleTest3D(self, savePlot=True, showPlot=True, saveDir="./", extension=".png"):
        fs = 10 # fontsize for axes
        dof_labels = ['x','y','z']
        var_color = 'r'
        var_alpha = 0.3
        ...
        # self.addCubeTo3DPlot(ax_3d, [0.2, 0.1, 1.1], [0.15, 0.1, 0.15])
    ...
    def addCubeTo3DPlot(axes, origin, dims):
        # Face 1
        ...
        axes.plot_surface(x3,y3,z3)
        axes.plot_surface(x4,y4,z4)
        axes.plot_surface(x5,y5,z5)
